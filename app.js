...
async function loadAllItems() {
    ...
    // 2. ФОНОВЫЙ ЗАПРОС К БД (Supabase никогда не спит, ответ за 0.1с)
...
async function initHitCounter() {
    ...
    try {
        ...
        // Если сервер "уснул" на Render, просто показываем нули, чтобы не ломать дизайн
        counterEl.innerText = '0 0 0 0 0';
    }
}
// ==========================================
...
function handleLiveSearch() {
    ...
    searchDebounce = setTimeout(() => {
        ...
        const fuseOptions = {
            includeScore: true, 
            includeMatches: true, // Включаем поиск совпадений для подсветки
        ...
        if (results.length > 0) {
            ...
            results.forEach(result => {
                ...
                // Функция для подсветки совпадений зеленым цветом
